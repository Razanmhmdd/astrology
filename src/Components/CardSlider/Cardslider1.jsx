...
const Cardslider1 = () => {
            ...
            <p className="text-gray-700 text-justify">
  {
    "ksjqka orejka ksfhdackh lrk ñ:qk nqO .%yhd úiska md,kh lrkq ,nk jd; rdYshls'. Tjqkaf.a nyqld¾h;dj fldrfmd;= j,ska ksfhdackh jk ;=,d hkq isl=re úiska md,kh lrk jdhq ,l=Kls'. fuu ,l=K hgf;a Wm; ,nk mqoa.,hka rdÊh;dka;aßl, wdl¾YkSh iy wdor yeÕSï we;s wh fõ'. idOdrK;ajh iy hqla;sh ms<sn| iajNdúl yeÕSula we;s ,sn%dia Ôú;fha iEu wxYhlu iu.sh iy iunr;djh wfmalaId lrhs'. Tjqka iqkaor;ajh i|yd oeä weila we;s w;r l,dj, ix.S;h iy ixialD;sh iuÕ ;uka jgd úfkdao fj;s."
        ...
        <div className="max-w-sm rounded overflow-hidden shadow-lg bg-slate-100">
          ...
          <div className="px-6 py-4 text-sin">
            <div className="font-bold text-xl mb-2">වෘශ්චික</div>
            ...
            <p className="text-gray-700 text-justify leading-relaxed">
  {
    ...
    <div className="px-6 py-4">
      <div className="font-bold text-xl mb-2 text-center">කුම්භ</div>
      <span className="text-gray-700 text-justify leading-relaxed text-sin">
        c,orkakd úiska ksfhdackh lrk l=ïN" hqf¾kia iy fikiqre úiska md,kh lrk jdhq ,l=Kls. 
        fuu ,l=K hgf;a Wmka mqoa.,hka iajdëk mar.;sYS,S iy udkqISh fõ. ;SlaIaK nqoaêhla iy ler,sldr wd;auhla we;s.
      </span>
      <span className='gap-4' >Aquarins</span>
      <span className="text-gray-700 text-justify leading-relaxed text-sin">
        iudc wruqKq fjkqfjka iy kfjda;amdokhka je,| .kakd ¥ro¾YS fõ. Tjqkaf.a úflakao%sh;ajh iy m%Njh Tjqka jgd f,dalh 
        fjkia lsÍug iy úma,jhla we;s lrhs.
      </span>
    </div>
  </div>
