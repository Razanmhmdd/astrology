...
const Footer = () => {
  return (
    <div>
        <footer className="footer bg-gradient-to-r from-violet-200 to-pink-200 text-base-content p-10 font-medium">
  ...
  <nav>
    ...
    <Link className="link link-hover" to="/pack">Packages</Link>
    <Link className="link link-hover" to="/contact">Contact</Link>
    <Link className="link link-hover" to="/gallery">Gallery</Link>
...
<footer className="footer bg-gradient-to-r from-violet-200 to-pink-200 text-base-content border-base-300 border-t px-10 py-4">
  <aside className="grid-flow-col items-center">
    ...
    Silicon Radon Networks (Pvt) Ltd   </p>
  </aside>
