...
const Footer = () => {
  return (
    <div>
        <footer className="footer bg-purple-400 text-base-content p-10 font-medium">
...
<footer className="footer bg-purple-400 text-base-content border-base-300 border-t px-10 py-4">
  <aside className="grid-flow-col items-center">
    ...
    <a
            ...
            >
    Silicon Radon Networks (Pvt) Ltd </a>  </p>
  </aside>
</footer>
</div>
    </div>
