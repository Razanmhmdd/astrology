...
const HoroscopeForm = () => {
  return (
    <div
      className="min-h-screen bg-cover bg-center flex flex-col items-center justify-start px-4 lg:px-0 py-8"
      style={{
    ...
    >
      ...
      <div className="w-full max-w-[600px] mb-6 text-center">
        <div className="bg-gradient-to-r from-purple-500 to-purple-900 text-white rounded-xl p-4 shadow-lg">
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Professional Horoscope Reading</h1>
          <p className="text-purple-100">Expert Analysis of Your Celestial Path</p>
        </div>
      </div>

      {/* Form Container */}
      <div className="bg-white w-full max-w-[600px] p-6 md:p-8 lg:p-10 rounded-xl shadow-xl border-2 border-purple-900 mb-6">
        {/* Title */}
        ...
        <form className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            <div className="flex-1">
              ...
              <select className="w-full px-4 py-2 rounded-lg border border-purple-300 focus:border-purple-500 focus:ring-purple-500 text-purple-700">
                <option>Aries</option>
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full px-4 py-2 rounded-lg border border-purple-300 focus:border-purple-500 focus:ring-purple-500 text-purple-700"
      ...
      {/* <div className="w-full max-w-[600px] grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white/90 p-4 rounded-xl shadow-lg border border-purple-300">
        ...
        <div className="bg-white/90 p-4 rounded-xl shadow-lg border border-purple-300">
          <h3 className="text-lg font-semibold text-purple-700 mb-2">Important Notice</h3>
